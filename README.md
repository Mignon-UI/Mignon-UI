...
## <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:sparkles.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:sparkles.svg?color=%231e293b" width="20" height="20" alt="" /></picture> Key Features

<dl>
  <dt><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:layout.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:layout.svg?color=%231e293b" width="16" height="16" alt="" /></picture> <b>Clean UI & Simple Setup</b></dt>
  ...
  <dt><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:users.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:users.svg?color=%231e293b" width="16" height="16" alt="" /></picture> <b>Dynamic Multi-Bot Lobbies</b></dt>
  ...
  <dt><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:book-open.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:book-open.svg?color=%231e293b" width="16" height="16" alt="" /></picture> <b>Tavern Card Imports & Lorebooks</b></dt>
  ...
  <dt><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:brain.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:brain.svg?color=%231e293b" width="16" height="16" alt="" /></picture> <b>Smart Story Memory</b></dt>
  ...
  <dt><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:shield-check.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:shield-check.svg?color=%231e293b" width="16" height="16" alt="" /></picture> <b>Private & Offline-First</b></dt>
  ...
  <dt><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:palette.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:palette.svg?color=%231e293b" width="16" height="16" alt="" /></picture> <b>Aesthetic Themes</b></dt>
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:image.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:image.svg?color=%231e293b" width="20" height="20" alt="" /></picture> Screenshots
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:rocket.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:rocket.svg?color=%231e293b" width="20" height="20" alt="" /></picture> Getting Started

### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:download.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:download.svg?color=%231e293b" width="18" height="18" alt="" /></picture> Installation
...
#### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/simple-icons:windows11.svg?color=%23ffffff"><img src="https://api.iconify.design/simple-icons:windows11.svg?color=%231e293b" width="16" height="16" alt="" /></picture> Windows
...
#### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/simple-icons:apple.svg?color=%23ffffff"><img src="https://api.iconify.design/simple-icons:apple.svg?color=%231e293b" width="16" height="16" alt="" /></picture> macOS (Universal: Intel & Apple Silicon)
...
#### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/simple-icons:linux.svg?color=%23ffffff"><img src="https://api.iconify.design/simple-icons:linux.svg?color=%231e293b" width="16" height="16" alt="" /></picture> Linux
...
### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:sliders.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:sliders.svg?color=%231e293b" width="18" height="18" alt="" /></picture> Onboarding Setup
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:cpu.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:cpu.svg?color=%231e293b" width="20" height="20" alt="" /></picture> Connecting Your AI Engine

Mignon UI is a frontend client that connects to your choice of local or cloud AI backends. Here is how to configure them:

### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/simple-icons:ollama.svg?color=%23ffffff"><img src="https://api.iconify.design/simple-icons:ollama.svg?color=%231e293b" width="16" height="16" alt="" /></picture> Local Ollama (Recommended for Beginners)
...
### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:zap.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:zap.svg?color=%231e293b" width="16" height="16" alt="" /></picture> Local Kobold.cpp (Recommended for Low-Spec Gaming Laptops)
...
### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:cloud.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:cloud.svg?color=%231e293b" width="16" height="16" alt="" /></picture> Cloud OpenRouter
...
### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:server.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:server.svg?color=%231e293b" width="16" height="16" alt="" /></picture> Custom (OpenAI-Compatible)
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:terminal.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:terminal.svg?color=%231e293b" width="20" height="20" alt="" /></picture> Developer Setup & Compiling from Source

If you want to run the project in development mode or compile your own installers:

### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:check-circle-2.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:check-circle-2.svg?color=%231e293b" width="18" height="18" alt="" /></picture> Prerequisites
...
### <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:play.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:play.svg?color=%231e293b" width="18" height="18" alt="" /></picture> Quick Start (Development Mode)
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.iconify.design/lucide:scale.svg?color=%23ffffff"><img src="https://api.iconify.design/lucide:scale.svg?color=%231e293b" width="20" height="20" alt="" /></picture> License & Legal Notice
