...
## <img src="https://api.iconify.design/lucide:sparkles.svg" width="20" height="20" /> Key Features

<dl>
  <dt><img src="https://api.iconify.design/lucide:layout.svg" width="16" height="16" /> <b>Clean UI & Simple Setup</b></dt>
  ...
  <dt><img src="https://api.iconify.design/lucide:users.svg" width="16" height="16" /> <b>Dynamic Multi-Bot Lobbies</b></dt>
  ...
  <dt><img src="https://api.iconify.design/lucide:book-open.svg" width="16" height="16" /> <b>Tavern Card Imports & Lorebooks</b></dt>
  ...
  <dt><img src="https://api.iconify.design/lucide:brain.svg" width="16" height="16" /> <b>Smart Story Memory</b></dt>
  ...
  <dt><img src="https://api.iconify.design/lucide:shield-check.svg" width="16" height="16" /> <b>Private & Offline-First</b></dt>
  ...
  <dt><img src="https://api.iconify.design/lucide:palette.svg" width="16" height="16" /> <b>Aesthetic Themes</b></dt>
...
## <img src="https://api.iconify.design/lucide:image.svg" width="20" height="20" /> Screenshots
...
## <img src="https://api.iconify.design/lucide:rocket.svg" width="20" height="20" /> Getting Started

### <img src="https://api.iconify.design/lucide:download.svg" width="18" height="18" /> Installation
...
#### <img src="https://api.iconify.design/simple-icons:windows11.svg" width="16" height="16" /> Windows
...
#### <img src="https://api.iconify.design/simple-icons:apple.svg" width="16" height="16" /> macOS (Universal: Intel & Apple Silicon)
...
#### <img src="https://api.iconify.design/simple-icons:linux.svg" width="16" height="16" /> Linux
...
### <img src="https://api.iconify.design/lucide:sliders.svg" width="18" height="18" /> Onboarding Setup
...
## <img src="https://api.iconify.design/lucide:cpu.svg" width="20" height="20" /> Connecting Your AI Engine

Mignon UI is a frontend client that connects to your choice of local or cloud AI backends. Here is how to configure them:

### <img src="https://api.iconify.design/simple-icons:ollama.svg" width="16" height="16" /> Local Ollama (Recommended for Beginners)
...
### <img src="https://api.iconify.design/lucide:zap.svg" width="16" height="16" /> Local Kobold.cpp (Recommended for Low-Spec Gaming Laptops)
...
### <img src="https://api.iconify.design/lucide:cloud.svg" width="16" height="16" /> Cloud OpenRouter
...
### <img src="https://api.iconify.design/lucide:server.svg" width="16" height="16" /> Custom (OpenAI-Compatible)
...
## <img src="https://api.iconify.design/lucide:terminal.svg" width="20" height="20" /> Developer Setup & Compiling from Source

If you want to run the project in development mode or compile your own installers:

### <img src="https://api.iconify.design/lucide:check-circle-2.svg" width="18" height="18" /> Prerequisites
...
### <img src="https://api.iconify.design/lucide:play.svg" width="18" height="18" /> Quick Start (Development Mode)
...
## <img src="https://api.iconify.design/lucide:scale.svg" width="20" height="20" /> License & Legal Notice
